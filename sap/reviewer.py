...
from sap.agent import Recognizer
...
class Reviewer:
    ...
    def reflect_meta_strategy(self, traj: Trajectory):
        ...
        template = OmegaConf.load("sap/templates/post_match.yaml")["REFLECT_META_STRATEGY"]
    ...
    def reflect_planner(self, strategy, obs, plan):
        template = OmegaConf.load("sap/templates/post_match.yaml")["REFLECT_PLANNER"]
