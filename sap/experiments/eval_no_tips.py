...
from sap.agent  import Planner, AceAgentWithoutTips
...
def main():
    ...
    runs_dir = f"runs/eval_no_tips/{opponent_name}"
    logger.set_level(logger.DEBUG)

    agent = AceAgentWithoutTips(player_id=0, map_name=map_name, **cfg.agents[0])
