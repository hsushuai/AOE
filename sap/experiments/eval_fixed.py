...
def main():
    ...
    agent = Planner(player_id=0, map_name=map_name, model=cfg.agents[0].model, prompt="few-shot-w-strategy", temperature=cfg.agents[0].temperature, max_tokens=cfg.agents[0].max_tokens, strategy="sap/data/strategies/strategy_23.json")
