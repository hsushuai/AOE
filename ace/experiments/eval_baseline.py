...
def main():
    cfg = parse_args()
    seen = [f"ace/data/train/{filename}" for filename in os.listdir("ace/data/train") if filename.endswith(".json")]
    unseen = [f"ace/data/test/{filename}" for filename in os.listdir("ace/data/test") if filename.endswith(".json")]
    seen_battle = []
